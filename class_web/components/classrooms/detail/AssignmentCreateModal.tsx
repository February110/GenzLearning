                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="rounded-full border px-4 py-1.5 text-sm w-64 disabled:opacity-60"
                    />
                    <button
                      type="button"
                      disabled={creating}
                      className="rounded-full border px-3 py-1.5 text-sm hover:bg-gray-50 dark:hover:bg-zinc-800 disabled:opacity-60"
                      onClick={() => {
                        if (linkInput.trim()) {
          ...
          <div className="space-y-3 lg:min-w-[380px] lg:max-w-[420px]">
            ...
            <div className="rounded-xl border border-indigo-200 dark:border-indigo-900 bg-white dark:bg-zinc-950 p-3 space-y-3 shadow-sm">
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-zinc-950 px-3 py-2 text-sm disabled:opacity-60"
                rows={6}
                ...
                <label className="flex items-center gap-2">
                  <span>Số câu:</span>
                    <input
                      ...
                      className="w-20 rounded-full border px-2 py-1 text-xs"
                    />
                  </label>
                  <div className="ml-auto flex items-center gap-2">
                    <button
                      ...
                      className="rounded-full bg-indigo-600 text-white px-3 py-1.5 text-xs hover:bg-indigo-700 disabled:opacity-50"
              ...
              {aiResults.length > 0 && (
                <div className="space-y-1 rounded-xl border border-indigo-200 dark:border-indigo-800 bg-indigo-50/40 dark:bg-indigo-950/20 p-2 text-sm">
                  ...
                  <div className="space-y-2 max-h-44 overflow-y-auto pr-1">
                    {aiResults.map((q, idx) => (
                      <div key={idx} className="rounded-xl border border-indigo-100 dark:border-indigo-800 p-2 bg-white dark:bg-zinc-900">
            ...
            <div className="pt-2 flex justify-end gap-2">
              ...
              <button type="submit" disabled={creating} className="rounded-full bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 text-sm disabled:opacity-60">
