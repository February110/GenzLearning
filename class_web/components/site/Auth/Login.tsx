              ...
              <div className="mb-8 flex flex-col lg:flex-row lg:gap-14 gap-6">
                ...
                <div className="relative w-full lg:w-1/2">
                  <input
                    ...
                    required
                    className="w-full border-b border-stroke bg-transparent pb-3.5 pr-10 text-gray-800 focus:border-primary focus:outline-none dark:border-strokedark dark:text-white"
                  />
                  <button
                    type="button"
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 p-1 text-gray-400 transition hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-200"
                  >
                    {showPassword ? (
                      <svg
                        width="18"
                        ...
                        aria-hidden="true"
                      >
                        <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-5 0-9.27-3.11-11-7 1.06-2.58 2.9-4.67 5.19-5.86" />
                        <path d="M10.58 10.58a2 2 0 0 0 2.83 2.83" />
                        <path d="M9.9 4.24A10.94 10.94 0 0 1 12 4c5 0 9.27 3.11 11 7-0.61 1.49-1.44 2.82-2.44 3.94" />
                        <path d="M1 1l22 22" />
                      </svg>
                    ) : (
                      <svg
