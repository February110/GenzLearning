...
{
    public class ClassroomGroupMemberConfiguration : IEntityTypeConfiguration<ClassroomGroupMember>
    {
        public void Configure(EntityTypeBuilder<ClassroomGroupMember> builder)
        {
